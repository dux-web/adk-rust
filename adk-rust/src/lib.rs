...
//! | `vertex-eval` | Gen AI Evaluation Service bridge (adk-eval) | (opt-in, any preset) |
//! | `vertex-rag` | Vertex AI RAG Engine retrieval client + tool (adk-rag) | (opt-in, any preset) |
